      ...
      <Container>
        <Row>
          <h1
            ...
            className="neonText fw-bold overlay-text text-center text-white my-5 home__title text-uppercase"
          >
            Tổng quan
          </h1>
        </Row>
        ...
        <Row>
          <div data-aos="fade-up" className="d-flex item-noibat my-4">
            <div
        ...
        >
          ...
          />
          <div
            className="info-husc align-self-center position-absolute top-50 start-50 translate-middle d-flex item-noibat justify-content-evenly align-items-center w-100 text-white"
